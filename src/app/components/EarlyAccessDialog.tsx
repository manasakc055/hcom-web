        ...
        >
          <div className="relative w-full max-w-xl overflow-hidden rounded-3xl border border-slate-200/50 bg-white p-8 text-slate-800 shadow-[0_40px_120px_-20px_rgba(15,23,42,0.25)]">
            ...
            <div className="space-y-3">
              ...
              >
                Tell us about your team and we’ll reach out with a tailored onboarding
                session once new seats open up.
              </p>
            </div>
            ...
            {submitted ? (
              <div className="mt-8 space-y-6 rounded-2xl bg-slate-50 p-6 text-sm text-slate-700 border border-slate-200">
                ...
                <p>
                  Our team will review your request and get in touch shortly with next
                  steps. We can’t wait to show you what HCOM can unlock for your
                  commerce stack.
                </p>
                <button
                  type="button"
                ...
                <div className="grid gap-4 sm:grid-cols-2">
                  <label className="text-sm font-medium text-slate-700">
                    ...
                    <input
                      ...
                      className="mt-2 w-full rounded-xl border border-slate-200 bg-slate-50 px-4 py-3 text-sm text-slate-900 placeholder:text-slate-400 focus:border-[#7C5CFF] focus:outline-none focus:ring-2 focus:ring-[#7C5CFF]/40"
                    />
                  </label>
                  <label className="text-sm font-medium text-slate-700">
                    Work email
                ...
                <div className="grid gap-4 sm:grid-cols-2">
                  ...
                  <label className="text-sm font-medium text-slate-700">
                    ...
                    <select
                      ...
                      required
                      defaultValue=""
                      className="mt-2 w-full rounded-xl border border-slate-200 bg-slate-50 px-4 py-3 text-sm text-slate-900 focus:border-[#7C5CFF] focus:outline-none focus:ring-2 focus:ring-[#7C5CFF]/40"
                    >
          ...
          <div className="relative w-full max-w-xl overflow-hidden rounded-3xl border border-slate-200/50 bg-white p-8 text-slate-800 shadow-[0_40px_120px_-20px_rgba(15,23,42,0.25)]">
            ...
            {submitted ? (
              ...
              <form className="mt-8 space-y-5" onSubmit={handleSubmit}>
                ...
                <button
                  type="submit"
                  className="inline-flex w-full items-center justify-center gap-2 rounded-lg bg-black via-[#2D3FE0] to-black px-6 py-3 text-sm font-semibold text-white shadow-lg shadow-blue-500/30 transition-transform hover:-translate-y-[2px]"
                >
                  Submit request
                </button>
              </form>
